...
def main():
    ...
    file_path = os.path.join(current_dir, "../compiled_annotations.csv")
    ...
    # Save results
    save_results(results, os.path.join(current_dir, "../sample_outputs/sentiment_focus_baselines_results.json"))
    print("Results saved to sample_outputs/sentiment_focus_baselines_results.json")
